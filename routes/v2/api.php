...
$routes = [
    ['method' => 'GET', 'path' => '/api/v2/cities', 'handler' => [CitiesController::class, 'index'] , 'auth' => true , "role"=>"user"],
    ['method' => 'GET', 'path' => '/api/v2/cities/{id}', 'handler' => [CitiesController::class, 'getById'] , 'auth' => true , "role"=>"user"],
    ...
    ['method' => 'GET', 'path' => '/api/v2/provinces', 'handler' => [ProvincesController::class, 'index'] , 'auth' => true , "role"=>"user"],
    ['method' => 'GET', 'path' => '/api/v2/provinces/{id}', 'handler' => [ProvincesController::class, 'getById'] , 'auth' => true , "role"=>"user"],
